...
Read `candidate-profile-sebastian.md` and `job-application.md` directly from disk for this invocation. Do this even if either file was read earlier in the conversation. Do not inspect or reuse `cv-output.json` as drafting input.
