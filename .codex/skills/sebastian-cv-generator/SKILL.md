...
description: Generate Sebastian Sygula's complete, strongly tailored ATS-friendly CV JSON from sparse repository runtime files. Use when tailoring Sebastian's CV to a job description, filling missing career details from target-role context, answering application questions, auditing CV quality, or writing Alex L/cv-output.json.
---
...
- Read candidate facts from `Alex L/candidate-profile-sebastian.md`.
...
- At the start of every invocation, read `Alex L/candidate-profile-sebastian.md` and `Alex L/job-application.md` from disk, even when their contents appeared earlier in the conversation or a previous invocation.
